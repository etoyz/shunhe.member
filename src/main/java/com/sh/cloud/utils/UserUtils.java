...
//	 * @return 取不到返回null
//	 */
//	public static MongoUser get(String id){
//		MongoUser user = (MongoUser)CacheUtils.get(USER_CACHE, USER_CACHE_ID_ + id);
//		if (user ==  null){
//			user = userDao.get(id);
//			if (user == null){
//				return null;
...
//			user.setGroupInfoList(groupInfoDao.findList(new GroupInfo(user)));
...
//		removeCache(CACHE_GROUP_INFO_LIST);
...
//		}
//		if (user.getGroupInfo() != null && user.getGroupInfo().getId() != null){
//			CacheUtils.remove(USER_CACHE, USER_CACHE_LIST_BY_GROUP_ID_ + user.getId());
//		}
